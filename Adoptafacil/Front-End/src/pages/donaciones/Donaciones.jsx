        ...
        {mostrarAgradecimiento ? (
          <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
              Tu generosa contribución de ${montoFinal} ayudará a muchas
              mascotas a encontrar un hogar amoroso. Hemos enviado un recibo a
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Tu apoyo nos permite rescatar, cuidar y encontrar hogares para
                mascotas abandonadas. Cada donación marca la diferencia.
              </p>
            </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div className="flex justify-between items-center text-lg">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {montoFinal
                          ? `$${parseInt(montoFinal).toLocaleString()}`
                          : "$0"}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    <button
                      type="submit"
                      disabled={!montoFinal}
                      className={`py-3 px-8 rounded-lg text-white font-medium text-lg transition ${
                        montoFinal
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Todas las transacciones son procesadas con los más altos
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  El 100% de tu donación se destina directamente al cuidado y
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ¿Tienes preguntas sobre donaciones? Escríbenos a
                  donaciones@adoptafacil.com
                </p>
              </div>
            </div>
          </div>
