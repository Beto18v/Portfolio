...
.skills-matrix-container {
    background:
        ...
        radial-gradient(circle at 80% 80%, rgba(255, 0, 128, 0.1) 0%, transparent 50%), linear-gradient(135deg, #000000 0%, #001122 50%, #000000 100%);
}
...
.skill-category:hover {
    box-shadow: 0 0 30px var(--category-color, #00d4ff);
}
...
.scrollbar-thumb-cyan-400::-webkit-scrollbar-thumb:hover {
    background: #00ffff;
}
