...
export const portfolioTranslations: TranslationData = {
    en: {
        ...
        'space.contact.response.online': 'I typically respond to messages within 24 hours. For urgent matters, please mention it in your message.',
    ...
    es: {
        ...
        'space.contact.response.online': 'Normalmente respondo los mensajes en menos de 24 horas. Si es urgente, por favor indícalo en tu mensaje.',
    ...
    zh: {
        ...
        'space.contact.response.online': '我通常会在24小时内回复消息。如有紧急事项，请在消息中注明。',
